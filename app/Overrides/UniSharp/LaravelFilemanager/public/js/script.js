...
function loadItems(page) {
    ...
    var paramPathValue = urlParams.get('path');
    var paramSelectValue = urlParams.get('select');
    ...
    if(paramPathValue && paramSelectValue){
        sendParams['param_path_value'] = paramPathValue;
        sendParams['param_select_value'] = paramSelectValue;
    ...
    performLfmRequest('jsonitems', sendParams, 'html')
        .done(function (data) {
            selected = [];
            ...
            if (hasItems) {
                ...
                items.forEach(function (item, index) {
                    ...
                    if(item.is_image){
                        if(paramSelectValue == item.name){
                            ...
                            template.find('.square').attr('id','x_selected');
                        }
                    }
                ...
                if(isSelected){
                    $('html, body').animate({
                        scrollTop: $('#x_selected').offset().top - 60
                    }, 1000);
                }
            }
            ...
            console.log('Current working_dir 000 : ' + working_dir);
            var breadcrumbs = [];
