<div class="input-wrapper {{$class ?? ''}} @if(isset($error) && $error) input-wrapper-error @endif @isset($icon) input-wrapper-icon @endisset" style="{{$style ?? ''}} @isset($width) ;width:{{$width}} @endisset">
    <div class="@if(isset($inline) && $inline) input-wrapper-inline @endif">
