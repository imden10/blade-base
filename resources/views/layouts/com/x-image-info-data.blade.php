<div class="flex flex-wrap">
    <div>
        <img src="{{$data['path']}}" class="size-[120px] rounded-md">
    </div>
    <div class="w-[calc(100%-120px)] pl-4">
        ...
        <p class="text-left rtl:text-right text-gray-500 dark:text-gray-400"><b>Розміри:</b> <span>{{$data['width']}} на {{$data['height']}} пікселів</span></p>
    </div>
</div>
